									...
									<View className="bg-white rounded-t-3xl pb-10">
										<View className="flex-row justify-between items-center p-4 border-b border-slate-100">
											<TouchableOpacity onPress={() => setShow(false)}>
												<Text className="text-red-500 font-semibold text-base">Annuler</Text>
											</TouchableOpacity>
											<Text className="font-bold text-lg text-slate-900">Choisir une date</Text>
											<TouchableOpacity onPress={() => setShow(false)}>
												<Text className="text-indigo-600 font-bold text-base">OK</Text>
											</TouchableOpacity>
										</View>
